                        ...
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="footer-tittle">
                                <div class="footer-pera">
                                    <p class="info1">Мы создаем пространства, в которых хочется жить. Профессиональный подход к дизайну и ремонту с гарантией качества.</p>
                                </div>
                            </div>
                            <div class="footer-number">
                                <h4><span>+998 </span>95 253 88 00</h4>
                                <p>info@integra-prodesign.uz</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row d-flex justify-content-between align-items-center">
                    <div class="col-xl-9 col-lg-8">
                        <div class="footer-copy-right">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                             Все права защищены | INTEGRA PRO.DESIGN 
                    ...
                    <div class="col-xl-3 col-lg-4">
                        ...
                        <div class="footer-social f-right">
                            ...
                            <a href="https://www.instagram.com/integra.stroy"><i class="fab fa-instagram"></i></a>
                            <a href="https://t.me/IntegraStroy"><i class="fab fa-telegram"></i></a>
