                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            <div class="hero__caption">
                                <span data-animation="fadeInLeft" data-delay=".4s">Добро пожаловать в INTEGRA PRO.DESIGN</span>
                                <h1 data-animation="fadeInLeft" data-delay=".6s">Дизайн и ремонт под ключ</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                        ...
                        <div class="section-tittle profession-details">
                            ...
                            <h2>Мы создаем современные интерьеры высочайшего уровня.</h2>
                            <p>Дизайн-проектирование, ремонт и строительство под ключ с гарантией качества и надежности.</p>
                            <p>INTEGRA PRO.DESIGN — это команда профессионалов, которая берет на себя все заботы о вашем ремонте. От первого эскиза до финальной уборки мы создаем пространства, в которых хочется жить и работать.</p>
                        </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <a href="about.php" class="btn btn3">Узнать больше о нас</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="single-services mb-200">
                        <div class="services-img">
                            ...
                            <h3><a href="services.php">Дизайн-проектирование</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="single-services mb-200">
                        <div class="services-img">
                            ...
                            <div class="services-caption">
                            <h3><a href="services.php">Строительство домов</a></h3>
                            <p class="pera1">Строительство частных домов</p>
                            <p class="pera2">Реализуем проекты частных домов с нуля под ключ с индивидуальным архитектурным решением.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="single-gallery mb-30">
                        ...
                        <div class="thumb-content-box">
                            <div class="thumb-content">
                                ...
                                <a href="work.php"><i class="fas fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="single-gallery mb-30">
                        ...
                        <div class="thumb-content-box">
                            <div class="thumb-content">
                                <h3><span>Дизайн</span>Современная квартира</h3>
                                <a href="work.php"><i class="fas fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        ...
                        <div class="team-caption">
                            ...
                            <span>Руководитель строительства</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        ...
                        <div class="team-caption">
                            ...
                            <span>Руководитель дизайна</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        ...
                        <div class="team-caption">
                            ...
                            <span>Руководитель маркетинга</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="h1-testimonial-active dot-style">
                        ...
                        <div class="single-testimonial text-center">
                            ...
                            <div class="testimonial-caption ">
                                <div class="testimonial-top-cap">
                                    <img src="assets/img/gallery/testi-logoorginal.png" alt="">
                                    <p>Очень довольны результатом! Команда INTEGRA PRO.DESIGN реализовала наш дизайн-проект точно в срок. Особенно порадовало внимание к деталям и качество отделочных работ. Квартира получилась именно такой, как мы мечтали.</p>
                                </div>
                                <!-- founder -->
                                <div class="testimonial-founder  ">
                                    <div class="founder-img">
                                        <span><strong>Алина Иванова</strong>   -   Владелец квартиры в ЖК Кислород</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-testimonial text-center">
                            ...
                            <div class="testimonial-caption ">
                                <div class="testimonial-top-cap">
                                    <img src="assets/img/gallery/testi-logoorginal.png" alt="">
                                    <p>Сделали ремонт под ключ в нашей квартире. Профессиональный подход на всех этапах — от дизайна до финальной уборки. Все сроки соблюдены, бюджет не превышен. Рекомендуем эту компанию всем друзьям и знакомым!</p>
                                </div>
                                <!-- founder -->
                                <div class="testimonial-founder  ">
                                    <div class="founder-img">
                                        <span><strong>Дмитрий Ким</strong>   -   Владелец квартиры в ЖК Паркентский</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            ...
                            <ul>
                                <li class="black-bg">15 января 2025</li>
                                <li>Автор: Admin   -   30 лайков   -   4 комментария</li>
                            </ul>
                            <div class="blog-cap">
                                <h3><a href="blog_details.php">Современный минимализм: как создать стильный интерьер</a></h3>
                                <a href="blog_details.php" class="more-btn">Читать далее</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            ...
                            <ul>
                                <li class="black-bg">12 января 2025</li>
                                <li>Автор: Admin   -   25 лайков   -   6 комментариев</li>
                            </ul>
                            <div class="blog-cap">
                                <h3><a href="blog_details.php">Этапы ремонта квартиры: от дизайна до финальной уборки</a></h3>
                                <a href="blog_details.php" class="more-btn">Читать далее</a>
                            </div>
                        </div>
                    </div>
